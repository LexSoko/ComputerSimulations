...
#converts to the intendend sweep array
#and gives back running averages
...
def theory_energy(x):
    ...
    return -2*(A/B)
#error estimation of the mean according to the script
...
#intigrates autocorr until noice
def auto_time(auto):
...
def get_lattice(L,spinRatio = 0.5):
    ...
    lattice[random<spinRatio] = -1
    return lattice
#for animating as the sim progresses
...
if __name__ == '__main__':
    main(a2b5=True, a3= False , bc3 = False, a4 =False,b4 = False, a5=True)
